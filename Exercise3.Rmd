...
# find the model with glm()
m <- glm(as.factor(high_use) ~ failures + absences + sex, data = alc, family = "binomial")
...
loss_func <- function(class, prob) {
  n_wrong <- abs(class - prob) > 0.5  #takes class, heavy use or not, 1 or 0. Then takes probability, set as 0. Substracts them. if class is 0 and prob is 0, result = 0. If class is 1 and prob is 0, number is positive = misclassification.  
  mean(n_wrong)
}
