...
* Course diary [here](https://raijin-90.github.io/IODS-project/)
* And of course [here's](https://github.com/Raijin-90/IODS-project) the course repo :)
...
paste0("Chapter complete on: ",date())
